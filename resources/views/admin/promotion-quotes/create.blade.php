        ...
        $initialItems = collect(old('items', [[]]))->map(function ($item) {
            ...
            $item['prints'] = collect($item['prints'] ?? [])->map(function ($print) {
                return [
                    ...
                    'setup_pricing_enabled' => $print['setup_pricing_enabled'] ?? null,
                    'setup_type' => $print['setup_type'] ?? null,
                    'setup_status' => $print['setup_status'] ?? ($print['cliche_status'] ?? null),
                    'setup_total_amount' => $print['setup_total_amount'] ?? null,
                    'setup_distribution_quantity' => $print['setup_distribution_quantity'] ?? null,
                    'setup_unit_amount' => $print['setup_unit_amount'] ?? null,
                    'base_print_unit_price' => $print['base_print_unit_price'] ?? ($print['print_unit_price'] ?? null),
