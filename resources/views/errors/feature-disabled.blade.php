...
<head>
    ...
    <title>Özellik Erişimi Kapalı - Prodelya</title>
...
<body class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="max-w-lg w-full bg-white border border-gray-200 rounded-xl shadow-sm p-8">
        ...
        <h1 class="text-2xl font-semibold text-gray-900 mb-2">Özellik erişimi kapalı</h1>
        <p class="text-sm text-gray-600 mb-6">{{ $message ?? 'Bu özellik tenant paketinizde aktif değil.' }}</p>

        <div class="rounded-lg bg-amber-50 border border-amber-200 p-4 text-sm text-amber-900">
            Bu işlem tenant erişim planınızda tanımlı olmadığı için güvenlik katmanında engellendi.
        </div>
