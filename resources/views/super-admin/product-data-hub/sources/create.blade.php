...
<div class="pd-form-shell">
        ...
        <div class="pd-card-body">
            <div class="pd-hub-section-head">
                <div>
                    ...
                    <div class="pd-hub-section-copy">Yeni kaynak kurulumunda teknik pipeline yerine yalnız karar adımlarını takip edin. Kaynak aktif olduktan sonra uygun ürünler otomatik senkronizasyonla satış listesine ve teklif ürün seçimine yansır.</div>
                </div>
            </div>
            <div class="pd-grid pd-grid-3">
                <div class="pd-note"><strong>1. Kaynak Bilgisi</strong><br>Kaynak adı, tedarikçi, format ve bağlantı ayarını kaydedin.</div>
                <div class="pd-note"><strong>2. Ön Kontrol</strong><br>Kaydı oluşturduktan sonra 5-10 örnek ürünü kontrol edin.</div>
                <div class="pd-note"><strong>3. Alan Eşleme</strong><br>Zorunlu alanları aynı akışta tamamlayın.</div>
                <div class="pd-note"><strong>4. İlk Kategori Eşleme</strong><br>Kaynak kategorilerini Prodelya genel kategorisine bağlayın.</div>
                <div class="pd-note"><strong>5. Gerekirse Toplu Değiştir</strong><br>Benzer kategoriler için tek seferde karar verin.</div>
                <div class="pd-note"><strong>6. Kaynağı Aktif Et</strong><br>Bundan sonra sistem normal senkronlarda uygun ürünleri otomatik yansıtır; yalnız sorunlu kayıtlar Bekleyen Kontroller alanına düşer.</div>
            </div>
        </div>
    </section>
        ...
        <div class="pd-card-body">
            <div class="pd-hero-main">
                <div class="pd-hero-copy">
                    ...
                    <p class="pd-hero-subtitle">Önce kaynak bilgisini kaydedin. Ardından ön kontrol, alan eşleme ve ilk kategori eşleme aynı kurulum zincirinde tamamlanır; ekstra havuza aktarma veya teklife gönderme adımı beklenmez.</p>
                    <div class="pd-hero-badges">
                        ...
                        <span class="pd-badge pd-badge-amber">Ön kontrol sonrası eşleme</span>
                    </div>
                </div>
            ...
            <div class="pd-note mt-4 pd-product-hub__auto-note">Bu ekranda yalnız başlangıç kaydı oluşturulur. Kaydettikten sonra <strong>Ön Kontrol Yap</strong>, <strong>Eşlemeyi Kaydet</strong>, <strong>Kategorileri Eşle</strong> ve gerekirse <strong>Bekleyen Kontrolleri Aç</strong> adımlarıyla devam edin.</div>
        </div>
    </section>
    ...
    <form action="{{ route('admin.super.product-data-hub.sources.store') }}" method="POST" id="sourceForm">
            ...
            <div class="pd-card-body">
                ...
                <div class="pd-form-grid-2 mt-4">
                    <div>
                        ...
                        <input type="text" name="product_node_path" class="pd-input" value="{{ old('product_node_path', $formDefaults['product_node_path'] ?? '') }}" placeholder="RECORD / urunler / Ürün">
                    </div>
                    <div>
        ...
        <div class="pd-card pd-form-card mb-6">
            <div class="pd-card-header">
                <h3 class="pd-card-title">Kaydetme Sonrası Ana Aksiyonlar</h3>
            </div>
            <div class="pd-card-body">
                <div class="pd-grid pd-grid-3">
                    <div class="pd-note"><strong>Ön Kontrol Yap</strong><br>5-10 örnek ürün üzerinden ürün adı, kod, fiyat, stok, görsel ve varyant okumasını doğrulayın.</div>
                    <div class="pd-note"><strong>Eşlemeyi Kaydet</strong><br>Ürün kodu, ürün adı, kategori, fiyat, stok, görsel ve açıklama alanlarını netleştirin.</div>
                    <div class="pd-note"><strong>Kategorileri Eşle</strong><br>Eşlenmeyen kategoriler satış listesine otomatik açılmaz; Bekleyen Kontroller alanına düşer.</div>
                </div>
                <div class="pd-note mt-4">Kaynak hazır olduktan sonra uygun ürünler Abone Firma ürün listesine ve teklif/sipariş ürün seçimine otomatik yansır. Ekstra “kataloğa aktar” veya “teklife aç” adımı normal kullanımda gerekmez.</div>
            </div>
        </div>
