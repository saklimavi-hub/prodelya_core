...
class SupplierLocalStockTwoVariantsSameParentTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_two_exact_variant_rows_from_same_parent_are_rendered_as_two_sellable_rows(): void
    {
        $supplier = $this->makeSupplierWithAccess('DUO');
        ...
        $catalogResponse->assertSeeText('Mavi');
        $catalogResponse->assertSeeText('Kırmızı');
        $this->assertSame(2, substr_count($catalogResponse->getContent(), 'İncele'));
    }
}
