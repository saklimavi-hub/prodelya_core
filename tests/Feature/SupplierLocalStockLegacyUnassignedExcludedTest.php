...
class SupplierLocalStockLegacyUnassignedExcludedTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_legacy_product_level_stock_for_varianted_product_is_excluded_from_exact_rows(): void
    {
        $supplier = $this->makeSupplierWithAccess('LEGACY-ONLY');
        ...
        $this->makeCatalogVariant($product, ['variant_code' => 'ET-0506-MV', 'variant_name' => 'ET-0506-MV Plastik Kalem Mavi']);
        $this->makeCatalogVariant($product, ['variant_code' => 'ET-0506-K', 'variant_name' => 'ET-0506-K Plastik Kalem Kırmızı']);
