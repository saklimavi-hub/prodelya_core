...
class SupplierLocalStockNoDoubleCountTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_parent_projection_is_not_double_counted_when_exact_variant_rows_exist(): void
    {
        $supplier = $this->makeSupplierWithAccess('NODOUBLE');
        ...
        $catalogResponse->assertDontSeeText('4.000');
    }
}
