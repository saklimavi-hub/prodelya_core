...
class Order extends Model
{
    ...
    protected $casts = [
        ...
        'currency_snapshot_summary' => 'array',
        'rates_refreshed_at' => 'datetime',
        'rates_refreshed_by' => 'integer',
        'current_rate_acknowledged_at' => 'datetime',
        'current_rate_acknowledged_by' => 'integer',
        'currency_snapshot_locked_at' => 'datetime',
    ];
