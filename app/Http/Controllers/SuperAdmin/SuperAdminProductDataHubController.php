        ...
        if ($searchFirstIdle) {
            return view('super-admin.product-data-hub.product-panel', [
                ...
                'reviewQueueCards' => [
                    ...
                    ['key' => 'category_waiting', 'title' => 'Eşleşmeleri Gözden Geçir', 'count' => 0, 'tone' => 'amber', 'copy' => 'Kategori kararı bekleyenler burada görünür.', 'href' => route('admin.super.product-data-hub.product-panel', ['review_bucket' => 'category_waiting'])],
                    ...
                    ['key' => 'projection_issues', 'title' => 'Otomatik Yansıma Sorunları', 'count' => 0, 'tone' => 'red', 'copy' => 'Katalog yansıması geri kalan satırlar burada izlenir.', 'href' => route('admin.super.product-data-hub.product-panel', ['review_bucket' => 'projection_issues'])],
                    ['key' => 'tenant_output_blocks', 'title' => 'Abone Firma Katalog Blokajları', 'count' => 0, 'tone' => 'purple', 'copy' => 'Erişim ve görünürlük blokları burada filtrelenir.', 'href' => route('admin.super.product-data-hub.product-panel', ['review_bucket' => 'tenant_output_blocks'])],
                ],
    ...
    private function pipelineSteps(array $counts): array
    {
        return [
            ...
            [
                ...
                'action_label' => 'Abone Firma Erişimleri',
                'action_route' => route('admin.super.tenant-supplier-access.index'),
            ],
            [
                'title' => 'Abone Firma Kataloğu',
                ...
                'action_label' => 'Abone Firma Kataloğu',
